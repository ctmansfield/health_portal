...
[BEGIN imported from CHANGE_LOG.md]
CHANGE LOG
==========
...
Null pointer failures caused by chart canvas elements missing in dynamically created containers fixed by building DOM elements explicitly and ensuring renderCharts associates canvases with their containers correctly.
